...
function ListHopitale() {
    ...
    return (
        ...
        <div>
            <h2 style={{ color: '#a67003', textAlign: 'center', fontSize: '50px' }}>Liste of Hopitale</h2>
            ...
            <div className="searchItem">
                ...
                <div className="siDesc">
                    <h1 className="siTitle">Hopitale 1</h1>
