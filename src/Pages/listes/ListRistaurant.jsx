...
function ListRistaurant() {
    ...
    return (
        ...
        <div>
            <h2 style={{ color: '#a67003', textAlign: 'center', fontSize: '50px' }}>Liste of restaurant</h2>
            ...
            <div className="searchItem">
                ...
                <div className="siDesc">
                    <h1 className="siTitle">restaurant 1</h1>
