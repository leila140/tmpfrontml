...
function ListTribinaux() {
    ...
    return (
        ...
        <div>
            <h2 style={{ color: '#a67003', textAlign: 'center', fontSize: '50px' }}>Liste of Tribinaux</h2>
            ...
            <div className="searchItem">
                ...
                <div className="siDesc">
                    <h1 className="siTitle">Tribinaux 1</h1>
